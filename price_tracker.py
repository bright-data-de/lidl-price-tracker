...
Info  : https://brightdata.de/products/insights/price-tracker/lidl
"""
...
# https://brightdata.de/products/web-scraper/lidl
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Lidl scraper at: https://brightdata.de/products/web-scraper/lidl\n"
